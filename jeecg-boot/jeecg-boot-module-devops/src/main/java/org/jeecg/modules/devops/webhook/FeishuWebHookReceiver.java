package org.jeecg.modules.devops.webhook;
...
//@RestController
@Slf4j
public class FeishuWebHookReceiver {
    ...
    public void received(HttpServletRequest request, HttpServletResponse response) throws Throwable {
