 ...
 */
@Data
@TableName("dev_ci_ut_daily")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="dev_ci_ut_daily对象", description="ci ut结果表")
public class DevCiUtDaily implements Serializable {
	...
	/**ci类型*/
	@Excel(name = "ci类型", width = 15)
    @ApiModelProperty(value = "ci类型")
    private java.lang.String ciType;
	/**jenkins任务号*/
	...
	/**ut结束时间*/
	@Excel(name = "ut结束时间", width = 15)
    @ApiModelProperty(value = "ut结束时间")
    private java.lang.String utEndTime;
	/**ut结果*/
