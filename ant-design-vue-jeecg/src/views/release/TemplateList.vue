<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('模板')">导出</a-button>
    ...
    <template-drawer ref="modalForm" @ok="modalFormOk"></template-drawer>
  </a-card>
</template>
...
<script>
  ...
  import TemplateDrawer from '@views/release/modules/TemplateDrawer.vue'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/release/template/list",
          delete: "/release/template/delete",
          deleteBatch: "/release/template/deleteBatch",
          exportXlsUrl: "/release/template/exportXls",
          importExcelUrl: "release/template/importExcel",
