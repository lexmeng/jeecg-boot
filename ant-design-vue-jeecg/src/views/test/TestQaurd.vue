  ...
  export default {
    ...
    data() {
      return {
        table1: {
          ...
          columns: [
            ...
            // },
            {
              title:'测试类型',
              align:"center",
              key: 'quardType_dictText'
            },
            {
              title:'测试平台版本',
              align:"center",
              key: 'quardPlatform_dictText'
            },
            // {
            //   title:'quard代码分支',
            //   align:"center",
        ...
        url: {
          ...
          listTastQuardJob: "/test/testQuardRequest/list",
        },
      }
    },
    // 监听器
    ...
    methods: {
      ...
      loadTable1Data() {
        ...
        getAction(this.url.listTastQuardJob, formData).then(res => {
          console.log('listTastQuardJob', res)
          if (res.success) {
            // 后台查询回来的 total，数据总数量
