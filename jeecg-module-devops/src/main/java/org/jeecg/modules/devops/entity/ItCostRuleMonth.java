 ...
 */
@Data
@TableName("it_cost_rule_month")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="it_cost_rule_month对象", description="固定月单价类型")
public class ItCostRuleMonth implements Serializable {
    ...
    private java.lang.Double monthPrice;
	/**创建人*/
